...
public interface HolidayService {
	 ...
	 * Save Holiday
	 */
	HolidayResponse saveHoliday(HolidayRequest request);
	 ...
	 * Get Holiday By Date
	 */
	HolidayResponse getHolidayByDate(LocalDate holidayDate);

	/**
	 * Check Whether Date Is Holiday (Used By Timetable Generator)
	 */
