...
public class SectionController {
	 ...
	 */
	@PostMapping
	public ResponseEntity<SectionResponse> saveSection(@Valid @RequestBody SectionRequest request) {
	...
	public ResponseEntity<SectionResponse> getSectionByCode(@PathVariable String sectionCode) {

		return ResponseEntity.ok(sectionService.getSectionByCode(sectionCode));
	}
	...
	public ResponseEntity<List<SectionResponse>> getSectionsBySemester(@PathVariable Long semesterId) {
