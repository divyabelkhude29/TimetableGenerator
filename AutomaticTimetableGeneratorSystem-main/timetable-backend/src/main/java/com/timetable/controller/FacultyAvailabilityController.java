...
public class FacultyAvailabilityController {
	...
	public ResponseEntity<FacultyAvailabilityResponse> saveFacultyAvailability(
		...
		FacultyAvailabilityResponse response = facultyAvailabilityService.saveFacultyAvailability(request);
	...
	public ResponseEntity<FacultyAvailabilityResponse> updateFacultyAvailability(@PathVariable Long availabilityId,
			@Valid @RequestBody FacultyAvailabilityRequest request) {

		FacultyAvailabilityResponse response = facultyAvailabilityService.updateFacultyAvailability(availabilityId,
				request);
	...
	public ResponseEntity<String> deleteFacultyAvailability(@PathVariable Long availabilityId) {

		facultyAvailabilityService.deleteFacultyAvailability(availabilityId);

		return ResponseEntity.ok("Faculty Availability deleted successfully.");
	}
	...
	public ResponseEntity<FacultyAvailabilityResponse> getFacultyAvailabilityById(@PathVariable Long availabilityId) {

		return ResponseEntity.ok(facultyAvailabilityService.getFacultyAvailabilityById(availabilityId));
	}
	...
	public ResponseEntity<List<FacultyAvailabilityResponse>> getAllFacultyAvailability() {
		...
		return ResponseEntity.ok(facultyAvailabilityService.getAllFacultyAvailability());
	}
	...
	public ResponseEntity<List<FacultyAvailabilityResponse>> getFacultyAvailabilityByFaculty(
		...
		return ResponseEntity.ok(facultyAvailabilityService.getFacultyAvailabilityByFaculty(facultyId));
	}
	...
	public ResponseEntity<List<FacultyAvailabilityResponse>> getFacultyAvailabilityByDay(
		...
		return ResponseEntity.ok(facultyAvailabilityService.getFacultyAvailabilityByDay(dayOfWeek));
	}
	...
	public ResponseEntity<List<FacultyAvailabilityResponse>> getFacultyAvailabilityByFacultyAndDay(
			@PathVariable Long facultyId, @PathVariable String dayOfWeek) {

		return ResponseEntity
				.ok(facultyAvailabilityService.getFacultyAvailabilityByFacultyAndDay(facultyId, dayOfWeek));
	}
}