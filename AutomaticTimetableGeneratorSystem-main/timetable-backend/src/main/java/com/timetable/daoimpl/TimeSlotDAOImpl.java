...
public class TimeSlotDAOImpl implements TimeSlotDAO {
	...
	public List<TimeSlot> findAll() {
		...
		return getCurrentSession().createQuery("FROM TimeSlot t ORDER BY t.dayOfWeek, t.slotOrder", TimeSlot.class)
				.getResultList();
	}
	...
	public List<TimeSlot> findByDayOfWeek(String dayOfWeek) {
		...
		return getCurrentSession()
				.createQuery("FROM TimeSlot t WHERE t.dayOfWeek = :dayOfWeek ORDER BY t.slotOrder", TimeSlot.class)
	...
	public TimeSlot findByDayOfWeekAndSlotOrder(String dayOfWeek, Integer slotOrder) {
		...
		List<TimeSlot> slots = getCurrentSession()
				.createQuery("FROM TimeSlot t WHERE t.dayOfWeek = :dayOfWeek AND t.slotOrder = :slotOrder",
						TimeSlot.class)
				.setParameter("dayOfWeek", dayOfWeek).setParameter("slotOrder", slotOrder).getResultList();
	...
	public List<TimeSlot> findBySlotOrder(Integer slotOrder) {
		...
		return getCurrentSession()
				.createQuery("FROM TimeSlot t WHERE t.slotOrder = :slotOrder ORDER BY t.dayOfWeek", TimeSlot.class)
				.setParameter("slotOrder", slotOrder).getResultList();
	}
	...
	public boolean existsByDayOfWeekAndSlotOrder(String dayOfWeek, Integer slotOrder) {
		...
		Long count = getCurrentSession()
				.createQuery(
						...
						Long.class)
				.setParameter("dayOfWeek", dayOfWeek).setParameter("slotOrder", slotOrder).uniqueResult();
