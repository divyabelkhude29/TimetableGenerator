...
public class SubjectWorkloadDAOImpl implements SubjectWorkloadDAO {
	...
	public SubjectWorkload findById(Long workloadId) {
		...
		return getCurrentSession().get(SubjectWorkload.class, workloadId);
	}
	...
	public List<SubjectWorkload> findAll() {
		...
		return getCurrentSession().createQuery("FROM SubjectWorkload sw ORDER BY sw.workloadId", SubjectWorkload.class)
				.getResultList();
	}
	 ...
	 */
	@Override
	public SubjectWorkload findByAllocation(FacultySubjectAllocation allocation) {

		return getCurrentSession()
				.createQuery("FROM SubjectWorkload sw WHERE sw.allocation = :allocation", SubjectWorkload.class)
				.setParameter("allocation", allocation).uniqueResult();
	}
	 ...
	 */
	@Override
	public boolean existsByAllocation(FacultySubjectAllocation allocation) {

		Long count = getCurrentSession()
				.createQuery("SELECT COUNT(sw) FROM SubjectWorkload sw " + "WHERE sw.allocation = :allocation",
						Long.class)
				.setParameter("allocation", allocation).uniqueResult();
	 ...
	 */
	@Override
	public boolean existsByAllocationAndNotWorkloadId(FacultySubjectAllocation allocation, Long workloadId) {

		Long count = getCurrentSession()
				.createQuery("SELECT COUNT(sw) FROM SubjectWorkload sw " + "WHERE sw.allocation = :allocation "
						+ "AND sw.workloadId <> :workloadId", Long.class)
				.setParameter("allocation", allocation).setParameter("workloadId", workloadId).uniqueResult();
