...
public interface FacultyAvailabilityDAO {
	 ...
	 */
	List<FacultyAvailability> findByFacultyAndDay(Faculty faculty, String dayOfWeek);
	 ...
	 */
	FacultyAvailability findByFacultyAndDayAndTimeSlot(Faculty faculty, String dayOfWeek, TimeSlot timeSlot);

	/**
	 * Check Duplicate Faculty Availability
	 */
	boolean existsByFacultyAndDayAndTimeSlot(Faculty faculty, String dayOfWeek, TimeSlot timeSlot);
}