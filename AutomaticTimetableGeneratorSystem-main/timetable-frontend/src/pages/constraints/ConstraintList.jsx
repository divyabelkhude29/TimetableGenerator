...
const ConstraintList = () => {
  ...
  const loadConstraints = async () => {
    try {
      ...
      const sortedConstraints = Array.isArray(response)
        ? [...response].sort(
            (a, b) => a.constraintId - b.constraintId
          )
        : [];
  ...
  const filteredConstraints = useMemo(() => {
    ...
    return constraints
      .filter((constraint) => {
        return (
          ...
          constraint.constraintKey
            ?.toLowerCase()
            .includes(keyword) ||
          String(constraint.constraintValue)
            .toLowerCase()
            .includes(keyword) ||
      ...
      .sort((a, b) => a.constraintId - b.constraintId);
  }, [constraints, search]);
  ...
  const handleSave = async () => {
    try {
      if (editing) {
        ...
        await constraintService.createConstraint(formData);
      }
